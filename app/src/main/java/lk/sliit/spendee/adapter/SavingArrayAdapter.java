...
public class SavingArrayAdapter extends ArrayAdapter<SavingModel> implements View.OnClickListener {

    private final int resource;
    private SavingModel model;

    public SavingArrayAdapter (@NonNull Context context , int resource , @NonNull List<SavingModel> objects){
