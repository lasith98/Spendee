...
public class InvestmentArrayAdapter extends ArrayAdapter<InvestmentModel> implements View.OnClickListener{
    private final int resource;
    private InvestmentModel model;

    public InvestmentArrayAdapter(@NonNull Context context, int resource, @NonNull List<InvestmentModel> objects) {
    ...
    public void onClick(View view) {
        Intent intent = new Intent(getContext(), InvestmentAeActivity.class);
